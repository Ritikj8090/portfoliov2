...
const Contact = () => {
  return (
    <section id="contact" className="h-[600px] bg-[#0f0d15] overflow-hidden">
        ...
        <div className="xl:mx-auto ml-10 w-[1200px]">
          ...
          <div className="ml-7">
            ...
            <motion.button
              ...
              className="btn shadow rounded-3xl w-[200px] h-[50px] font-mono font-semibold px-2 py-2  text-xl "
            >
              GET IN TOUCH
            </motion.button>
          </div>
          <div className="ml-7 translate-y-[250px] deactivate font-mono">
