...
const Home = ({ dot, border }) => {
  ...
  const makeArrary = () => {
    return Array.from({ length: 1792 }, (_, index) => (
      <div key={index} className=" ">
        <div
            key={index}
            className={`h-16 w-16 flex item`}
  ...
  return (
    ...
    <section id="home" className="h-screen w-full py-52 px-5 flex  "> 
    <div className="flex xl:mx-auto w-[1200px] ml-10 z-10">
